                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        disabled={isLoading}
                        className={`pl-10 h-11 transition-all duration-200 bg-white/10 border-white/20 text-white placeholder:text-white/50 ${
                          errors.username ? 'border-red-300 focus:border-red-500' : 'border-white/20 focus:border-green-500'
                        }`}
                      />
                    </div>
                    {errors.username && (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        disabled={isLoading}
                        className={`pl-10 h-11 transition-all duration-200 bg-white/10 border-white/20 text-white placeholder:text-white/50 ${
                          errors.email ? 'border-red-300 focus:border-red-500' : 'border-white/20 focus:border-green-500'
                        }`}
                      />
                    </div>
                    {errors.email && (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        disabled={isLoading}
                        className={`pl-10 pr-10 h-11 transition-all duration-200 bg-white/10 border-white/20 text-white placeholder:text-white/50 ${
                          errors.password ? 'border-red-300 focus:border-red-500' : 'border-white/20 focus:border-green-500'
                        }`}
                      />
                      <button
                        type="button"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        disabled={isLoading}
                        className={`pl-10 pr-10 h-11 transition-all duration-200 bg-white/10 border-white/20 text-white placeholder:text-white/50 ${
                          errors.confirmPassword ? 'border-red-300 focus:border-red-500' : 'border-white/20 focus:border-green-500'
                        }`}
                      />
                      <button
                        type="button"
